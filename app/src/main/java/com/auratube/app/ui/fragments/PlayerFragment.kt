...
import com.auratube.app.api.JsonHelper
...
import com.auratube.app.compat.PictureInPictureCompat
import com.auratube.app.compat.PictureInPictureParamsCompat
import com.auratube.app.constants.IntentData
import com.auratube.app.databinding.FragmentPlayerBinding
...
import com.auratube.app.enums.PlayerEvent
import com.auratube.app.enums.SbSkipOptions
import com.auratube.app.enums.ShareObjectType
import com.auratube.app.extensions.formatShort
import com.auratube.app.extensions.parcelable
import com.auratube.app.extensions.serializableExtra
import com.auratube.app.extensions.toID
import com.auratube.app.extensions.togglePlayPauseState
import com.auratube.app.extensions.updateIfChanged
...
import com.auratube.app.helpers.PlayerHelper.getCurrentSegment
import com.auratube.app.helpers.ThemeHelper
import com.auratube.app.helpers.WindowHelper
...
import com.auratube.app.services.OfflinePlayerService
import com.auratube.app.services.OnlinePlayerService
import com.auratube.app.ui.activities.AbstractPlayerHostActivity
import com.auratube.app.ui.activities.NoInternetActivity
import com.auratube.app.ui.adapters.VideoCardsAdapter
import com.auratube.app.ui.base.BaseActivity
import com.auratube.app.ui.dialogs.AddToPlaylistDialog
import com.auratube.app.ui.dialogs.PlayOfflineDialog
import com.auratube.app.ui.dialogs.ShareDialog
import com.auratube.app.ui.extensions.animateDown
import com.auratube.app.ui.extensions.getSystemInsets
import com.auratube.app.ui.extensions.setOnBackPressed
import com.auratube.app.ui.extensions.setupSubscriptionButton
import com.auratube.app.ui.interfaces.CustomPlayerCallback
import com.auratube.app.ui.interfaces.TimeFrameReceiver
import com.auratube.app.ui.listeners.SeekbarPreviewListener
import com.auratube.app.ui.models.ChaptersViewModel
import com.auratube.app.ui.models.CommentsViewModel
import com.auratube.app.ui.models.CommonPlayerViewModel
import com.auratube.app.ui.models.PlayerViewModel
import com.auratube.app.ui.sheets.CommentsSheet
import com.auratube.app.util.OfflineTimeFrameReceiver
import com.auratube.app.util.OnlineTimeFrameReceiver
import com.auratube.app.util.PlayingQueue
import com.auratube.app.util.TextUtils
import com.auratube.app.util.TextUtils.toTimeInSeconds
...
class PlayerFragment : Fragment(R.layout.fragment_player), CustomPlayerCallback {
    ...
    private fun initializeTransitionLayout() {
        ...
        binding.playerMotionLayout.addTransitionListener(object : TransitionAdapter() {
            override fun onTransitionChange(
                ...
                val p = progress.absoluteValue
                val radius = (p * 16 * resources.displayMetrics.density).toInt()
                applyRoundOutline(binding.player, radius)
                applyRoundOutline(binding.mainContainer, radius)
            ...
            override fun onTransitionCompleted(motionLayout: MotionLayout?, currentId: Int) {
                ...
                if (currentId == transitionStartId) {
                    ...
                    applyRoundOutline(binding.player, 0)
                    applyRoundOutline(binding.mainContainer, 0)
                    // re-enable captions
                    ...
                    val radius = (16 * resources.displayMetrics.density).toInt()
                    applyRoundOutline(binding.player, radius)
                    applyRoundOutline(binding.mainContainer, radius)
    ...
    private fun applyRoundOutline(view: View, radius: Int) {
        if (radius <= 0) {
