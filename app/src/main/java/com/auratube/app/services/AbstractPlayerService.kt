...
import com.auratube.app.extensions.updateParameters
...
import com.auratube.app.util.DefaultTrackSelectorWithAudioQualitySupport
import com.auratube.app.util.NowPlayingNotification
import com.auratube.app.util.PauseableTimer
...
abstract class AbstractPlayerService : MediaLibraryService(), MediaLibrarySession.Callback {
    ...
    private fun createPlayerAndMediaSession() {
        ...
        // prevent android from putting AuraTube to sleep when locked
