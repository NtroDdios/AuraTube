...
import com.auratube.app.helpers.ShortcutHelper
import com.auratube.app.util.ExceptionHandler

class AuraTubeApp : Application() {
    ...
    companion object {
        lateinit var instance: AuraTubeApp
